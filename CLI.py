...
def C13():
    ...
    userPAN = input("Enter the PAN of the user to be deleted : ")

    # query
    try:
        q = "delete from USERS where PAN = '{x}';".format(x=userPAN)
        CURSOR.execute(q)
    except Exception as err:
        print(err)
    ...
    try:
        ...
        with CONNECTION.cursor() as CURSOR:
            ...
            while 1:
                ...
                print("3  -> names of all stocks with share price greater than a value")
